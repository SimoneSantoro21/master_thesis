...
from models.dataset_all_bvecs import DiffusionDataset
...
DATA_PATH = "C:/Users/User/Desktop/2neighbors"
...
# Data Loaders
train_dataset = DiffusionDataset(TRAINING_PATH, resize_shape=(128, 128))
train_dataloader = DataLoader(dataset=train_dataset, batch_size=batch_size, shuffle=True, drop_last=True)

val_dataset = DiffusionDataset(VALIDATION_PATH, resize_shape=(128, 128))
...
for epoch in range(num_epochs):
    ...
    torch.save(netG.state_dict(), os.path.join(checkpoint_dir, f'netG_bvec.pth'))
    torch.save(netD.state_dict(), os.path.join(checkpoint_dir, f'netD_bvec.pth'))
